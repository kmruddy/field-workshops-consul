...
curl --silent --remote-name https://releases.hashicorp.com/consul-terraform-sync/0.5.1+ent/consul-terraform-sync_0.5.1+ent_linux_amd64.zip
unzip consul-terraform-sync_0.5.1+ent_linux_amd64.zip
...
working_dir  = "/etc/consul-tf-sync.d/sync-tasks"
